<template>
    ...
    <button @click="getAllTrainingOfOneUser(1)">{{currentMonth.name}}</button>
...
<script lang="ts">
    ...
    export default {
        ...
        methods: {
            ...
            ...mapActions(useTrainingStore, ["getAllTrainingOfOneUser", "getCurrentTraining", "modifySetStore", "deleteSet","postSetStore"]),
